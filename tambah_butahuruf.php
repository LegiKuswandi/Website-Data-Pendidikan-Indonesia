            ...
            <div class="gradient-custom-1 h-100">
                ...
                <div class="container">
                    <div class="section-header">
                        <br>
                        <p>Tambah<span> Data Buta Huruf </span>Baru</p>
                    </div>
                    <form action="#" method="POST" id="form-add" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="number" step="any" id="persentase" name="persentase" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <?php
                        if (isset($_POST['btn-add'])) {
                            ...
                            $isAddSucceed = addbutahuruf($_POST, $_FILES);
                            if ($isAddSucceed > 0) {
