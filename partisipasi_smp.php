                  ...
                  <div class="card mt-3">
                      ...
                      <div class="ms-3 mt-3">
                        <div class="mb-2">
                            ...
                            <a href=""><button type="button" class="btn btn-success" >SMP/Mts</button></a>
                            <a href="partisipasi_sma.php"><button type="button" class="btn btn-success" >SMA/SMK/MA</button></a>
                        </div>
                      ...
                      <div class="card-body">
                          <div class="table-responsive">
                              <table id="example1" class="table table-bordered table-striped" style="font-size: 14px;">
                                  ...
                                  <tbody id="showdata">
                                  <?php
                                    foreach ($listpsmp as $psmp) {
                                        $listpsmp = readpsd($psmp['id_partisipasi'])
                                        ?>
                                        <tr>
                                            <td><?=$psmp['nama_provinsi']?></td>
                                            <td><?=$psmp['angka_partisipasi_sekolah']?>%</td>
                                            <td><?=$psmp['angka_partisipasi_kasar']?>%</td>
                                            <td><?=$psmp['angka_partisipasi_murni']?>%</td>
                                            <td><?=$psmp['tahun_partisipasi']?></td>
                                            <td><?=$psmp['jenjang']?></td>
                                        </tr>
                                        <?php
                                      }
