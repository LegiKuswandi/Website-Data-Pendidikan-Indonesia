    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="active"  href="partisipasi.php">Partisipasi Pendidikan</a></li>
          ...
          <div class="row">
              <div class="col-12">
                  <div class="card mt-3">
                      ...
                      <div class="ms-3 mt-3">
                        <div class="mb-2">
                            <a href="partisipasi.php"><button type="button" class="btn btn-success" >SD/MI</button></a>
                            <a href="partisipasi_smp.php"><button type="button" class="btn btn-success" >SMP/Mts</button></a>
                            <a href=""><button type="button" class="btn btn-success" >SMA/SMK/MA</button></a>
                        </div>
                      ...
                      <div class="card-body">
                          <div class="table-responsive">
                              <table id="example1" class="table table-bordered table-striped" style="font-size: 14px;">
                                  ...
                                  <tbody id="showdata">
                                  <?php
                                    foreach ($listpsma as $psma) {
                                        $listpsma = readpsd($psma['id_partisipasi'])
                                        ?>
                                        <tr>
                                            <td><?=$psma['nama_provinsi']?></td>
                                            <td><?=$psma['angka_partisipasi_sekolah']?>%</td>
                                            <td><?=$psma['angka_partisipasi_kasar']?>%</td>
                                            <td><?=$psma['angka_partisipasi_murni']?>%</td>
                                            <td><?=$psma['tahun_partisipasi']?></td>
                                            <td><?=$psma['jenjang']?></td>
                                        </tr>
                                        <?php
                                      }
