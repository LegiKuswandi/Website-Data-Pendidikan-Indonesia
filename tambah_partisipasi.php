            ...
            <div class="gradient-custom-1 h-100">
                ...
                <div class="container">
                    <div class="section-header">
                        <br>
                        <p>Tambah<span> Data Partisipasi Pendidikan </span>Baru</p>
                    </div>
                    <form action="#" method="POST" id="form-add" enctype="multipart/form-data">
                            ...
                            <select class="form-select" aria-label="Category" id="provinsi" name="provinsi" required>
                                <?php
                                    foreach ($listprov as $prov) {
                                        $listprov = readbutahuruf($prov['id_provinsi'])
                                        ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="number" step="any" id="aps" name="aps" required>
                        </div>
                        <div class="mb-3">
                            <label for="persentase" class="form-label">Persentase APK</label>
                            <input class="form-control" type="number" step="any" id="apk" name="apk" required>
                        </div>
                        <div class="mb-3">
                            <label for="persentase" class="form-label">Persentase APM</label>
                            <input class="form-control" type="number" step="any" id="apm" name="apm" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" name="btn-add" id="btn-add" form="form-add" class="btn btn-success">Submit</button>
                    ...
                    <?php
                        if (isset($_POST['btn-add'])) {
                            ...
                            $isAddSucceed = addpartisipasi($_POST, $_FILES);
                            if ($isAddSucceed > 0) {
