              ...
              <div class="col-12">
                  <div class="card mt-1">
                      <div class="card-header">
                          <h3 class="card-title">Data E-Book</h3>
                      </div>
                      <div class="ms-3 mt-3">
                        <div class="form-outline d-flex justify-content-end">
                              <input class="me-3" type="text" id="getEbook" placeholder="Cari E-Book"/>
                              <a class="me-4" href="tambah_ebook.php"><button type="button" class="btn btn-success">Tambah Data</button></a>
                          </div>
                      </div> 
                      <!-- /.card-header -->
                      <div class="card-body">
                                  ...
                                  <?php
                                    foreach ($listebook as $ebook) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$ebook['jenjang']?></td>
                                            <td><a href='E-Book/<?php echo $ebook['ebook']; ?>' target='_blank'><?php echo $ebook['ebook']; ?></a></td>
                                            <td>
                                                <a href="edit_ebook.php?id_ebook=<?=$ebook['id_ebook']?>" class="link-warning"><i class="bi bi-pencil-square">Edit</i></a>
                                                <a href="delete_ebook.php?id=<?=$ebook['id_ebook']?>" onclick="return confirm('Yakin Hapus?')"><i class="bi bi-trash3">Delete</i></a>
                                            </td>
                                        </tr>
                                        <?php
                                      }
