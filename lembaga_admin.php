                  ...
                  <div class="card mt-1">
                      ...
                      <div class="ms-3 mt-3">
                        <div class="form-outline d-flex justify-content-end">
                            <a class="me-4" href="tambah_lembaga.php"><button type="button" class="btn btn-success">Tambah Data</button></a>
                                  ...
                                  <?php
                                    foreach ($listlb as $lb) {
                                        ...
                                        <tr>
                                            ...
                                            ?></td>
                                            <td>
                                                <a href="edit_lembaga.php?id_lembaga=<?=$lb['id_lembaga']?>" class="link-warning"><i class="bi bi-pencil-square">Edit</i></a>
                                                <a href="delete_lembaga.php?id=<?=$lb['id_lembaga']?>" onclick="return confirm('Yakin Hapus?')"><i class="bi bi-trash3">Delete</i></a>
                                            </td>
                                        </tr>
                                        <?php
                                      }
